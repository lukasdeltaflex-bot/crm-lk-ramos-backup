...
// 🛡️ SINGLETON IMUTÁVEL V47: Bloqueio absoluto para evitar colisões ca9/b815
...
if (!g._firebaseDb) {
    try {
        // Forçagem de Long Polling e desativação de auto-detect para máxima estabilidade
