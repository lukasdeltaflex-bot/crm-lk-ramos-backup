...
// Singleton blindado para evitar "Unexpected State" no Firestore durante HMR ou múltiplas inicializações
...
// Inicializa o Firestore apenas uma vez com configurações de cache e singleton protegido
