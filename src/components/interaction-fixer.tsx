...
export function InteractionFixer() {
  useEffect(() => {
    ...
    const cleanup = () => {
      ...
      const hasOverlays = document.querySelectorAll('[data-radix-portal], [role="dialog"], [role="menu"]').length > 0;
    ...
    // Também executa ao clicar na tela (caso um modal tenha acabado de fechar)
    window.addEventListener('mousedown', () => setTimeout(cleanup, 50));
